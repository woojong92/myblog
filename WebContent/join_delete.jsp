  ...
  <body>
   ...
   <!-- Main Content -->
	<div class="container">
		...
		<form method="post" action="join_deleteAction.jsp">
		<table class="table table-hover">
			<tbody>
				...
				<tr>
					<td> 비밀번호 </td>
					<td><input type="password" class="form-control" value=password  name="passwd" maxlength="50"></td>
				</tr>
				...
				<tr>
                    <td colspan="3">
                        ...
                        <a href="my_page.jsp" class="btn btn-primary">취소</a>
